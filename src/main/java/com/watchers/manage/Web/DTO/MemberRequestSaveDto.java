...
@Getter
@NoArgsConstructor
public class MemberRequestSaveDto {
    private String name;
    private String tier;
    ...
    @Builder
    public MemberRequestSaveDto(String name, String tier, String gender, int age, Date enrolledDate, Set<Etc> etcs, Set<Caution> cautions){
        this.name = name;
        this.tier = tier;
        this.gender = gender;
        this.age = age;
